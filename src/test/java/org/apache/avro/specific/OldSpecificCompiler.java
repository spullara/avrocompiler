 ...
 */
public class OldSpecificCompiler {
  ...
  public OldSpecificCompiler(Protocol protocol) {
    // enqueue all types
  ...
  public OldSpecificCompiler(Schema schema) {
    enqueue(schema);
    this.protocol = null;
  }
  ...
  public static void compileProtocol(File src, File dest) throws IOException {
    ...
    OldSpecificCompiler compiler = new OldSpecificCompiler(protocol);
  ...
  public static void compileSchema(File src, File dest) throws IOException {
    ...
    OldSpecificCompiler compiler = new OldSpecificCompiler(schema);
    compiler.compileToDestination(dest);
  }
